...
class _HomeState extends State<Home> {
  Null datos;
  void _dataFireBase(){ db.collection("tb_students").where("first_name", isEqualTo: "Ana").get().then( (querySnapshot) { print("Successfully completed"); for (var docSnapshot in querySnapshot.docs) { print('${docSnapshot.id} => ${docSnapshot.data()}'); } },
  ...
  void _dataFireBase1(){
    ...
    db.collection("tb_students").get().then(
      (querySnapshot) { print("Successfully completed");
        for (var docSnapshot in querySnapshot.docs) {//datass = docSnapshot.data();
                ...
                return Dismissible(
                  ...
                  confirmDismiss: (direction) async{
                    ...
                    result = await showDialog(
                      ...
                      builder: (context){
                        return AlertDialog(
                          title: Text("¿Realmente desea eliminar a
